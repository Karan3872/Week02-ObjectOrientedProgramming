...
class Patient {
    ...
    private static String hospitalName = "Karan's Hospital";
...
public class HospitalManagementSystem 
{
    public static void main(String[] args) 
	{
		for(int i=1;i<=5;i++)
		{
			...
			Patient patient1 = new Patient("Josh Brown "+ Integer.toString(i), 45+i, "Flu " + Integer.toString(i), 101+i);
			Patient patient2 = new Patient("Marcus Stoinis "+ Integer.toString(i), 30+i, "Fever " + Integer.toString(i), 102+i);
