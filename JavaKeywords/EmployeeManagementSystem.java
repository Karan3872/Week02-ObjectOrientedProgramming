...
class Employee 
{
    ...
    private static String companyName = "Karan Animators";
...
public class EmployeeManagementSystem {
    public static void main(String[] args) {
        ...
        Employee emp1 = new Employee("Mitchell Johnson", 101, "Software Engineer");
        Employee emp2 = new Employee("Dwaine Smith", 102, "Project Manager");
