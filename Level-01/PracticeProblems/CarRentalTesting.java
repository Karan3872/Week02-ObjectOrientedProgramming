...
class CarRental 
{
    ...
    public CarRental() 
	{
        this.customerName = "Karan Anuragi";  // Setting default customer name
        this.carModel = "Tesla";  // Setting default car model
        this.rentalDays = 1;  // Setting default rental days
        this.rentalRatePerDay = 120.0; // Setting a default rental rate per day
    }
...
public class CarRentalTesting {
    public static void main(String[] args) {
        ...
        CarRental customRental = new CarRental("John Smith", "Toyota Camry", 7, 150.0);
